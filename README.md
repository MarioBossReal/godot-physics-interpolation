...
A basic example script <code>BasicInterpolator.cs</code> has been provided for demonstration. You can attach it directly to a node to test if interpolation is working, and see how different settings affect it.
